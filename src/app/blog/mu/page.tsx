        ...
        <div className='font-sarabun'>
            ...
            <div className='flex flex-col mx-5 xl:mx-80 lg:mx-40 md:mx-20 py-10 gap-5'>
                ...
                <div className='flex flex-col gap-3 text-lg'>
                    <p className='my-speech'>ชื่อนาย xxx ชื่อเล่น xxx มาจากโรงเรียนเบ็ญจะมะมหาราช จังหวัดอุบลราชธานี วันนี้มาสัมภาษณ์วิศวะคอม มหิดลครับ:</p>
                    <p>อจผญ: ทำไมถึงอยากเข้าที่นี่</p>
                    <p className='my-speech'>เคยมาค่าย clickcamp เลยชอบบรรยากาศของที่นี่ แล้วก็ชอบหลักสูตรของที่นี่ที่มีสาย cyber security:</p>
                    <p>อจผช: ถ้าได้ที่นี่จะเอามั้ย</p>
                    <p className='my-speech'>เอาครับ!(ตอบแบบไม่คิด):</p>
                    <p>อจผญ: เห็นมีสอวน.ด้วยนิ แล้วก็ถามว่าค่ายอะไรเป็นแบบไหน เรียนอะไรบ้าง</p>
                    <p className='short-description'>ก็อธิบายเกี่ยวกับค่ายแล้วก็บอกว่าเรียน data structure and algorithm</p>
                    <p>อจผญ: data structure ที่เรียนมีอะไรบ้าง เขียนภาษาอะไร</p>
                    <p className='my-speech'>List queue stack tree graph ใช้ C++ครับ:</p>
                    <p>แล้วอาจารย์ก็ถามว่าเคยทำโปรเจคอะไรมั้ย</p>
                    <p className='short-description'>ก็อธิบายโปรเจคที่เคยทำไป</p>
                    <p>อจผช: ถ้าเรียนที่นี่จะพักที่ไหน</p>
                    <p className='my-speech'>อาจจะอยู่หอครับ เป็นเด็กต่างจังหวัดแต่มีลุงอยู่ที่นี่พอดีเวลามีปัญหาอะไรก็ติดต่อญาติได้ง่ายเลยอยากเรียนที่นี่:</p>
                    <p className='short-description'>อาจารย์ก็ถามว่าบ้านอยู่ที่ไหน ลุงขับรถมาส่งหรออะไรแบบนี้</p>
                    <p>อจผช: ขออนุญาตถามได้มั้ยว่ายื่นที่ไหนบ้าง</p>
                    <p className='my-speech'>ยื่นลาดกระบังครับ ที่ดูไว้อีกก็มี เกษตร กับ บางมด แต่เขาเปิดรับหลังจากที่ที่นี่ประกาศแล้วเลยจะรอประกาศก่อน ถ้าติดก็ไม่ยื่นต่อ ถ้าไม่ได้คงต้องไปดูที่อื่น แต่ที่นี่ก็ใกล้ญาติด้วยเลยอยากได้ที่นี่ที่สุดครับ:</p>
                    <p>อจผญ: จบนี่จะทำอะไร</p>
                    <p className='my-speech'>มีแพลนจะเรียนต่อโทที่ต่างประเทศ เป็นสายบริหารธุรกิจ แล้วก็มาเปิดธุรกิจส่วนตัว:</p>
                    <p className='short-description'>อาจารย์ผญอึ้งแบบค้างไปเลย อาจารย์ผชเลยแนะนำว่าเรียนวิศวะเข้าใจการทำงานก่อนแล้วก็ต่อบริหารก็โอเค</p>
                    <p>อจผช: มีอะไรจะถามมั้ย</p>
                    <p className='short-description'>เลยถามเรื่องทุนไปว่ามีอะไรบ้าง แล้วก็ถามเรื่องชมรมยิงปืนไปเพราะแอบสนใจ</p>
                    <p>อจผช:นอกจากเขียนโปรแกรมมีเล่นกีฬาหรืออะไรมั้ย</p>
                    <p className='my-speech'>กำลังฝึกเล่นไวโอลินกับกีตาร์ครับ:</p>
                    <p>อจผช: ที่นี่มีชมรมดนตรีแล้วก็ข้างล่างมีกลองอยู่นะ</p>
                    <p className='short-description'>แล้วก็จบการสัมภาษณ์ด้วยการที่บอกกับอาจารย์ว่า &quot;ขอความกรุณาด้วยนะครับอาจารย์&quot;</p>
                    <p>อจผช:เลือกไม่ยากหรอก แต่คุณจะเอาที่นี่จริงหรือเปล่า ถ้าคุณไม่เอาก็เสียดายคนที่ผมตัดไป</p>
                    <p className='short-description'>เราเลยยิ้มให้อาจารย์แล้วก็ขอบคุณก่อนออกมา</p>
                </div>
