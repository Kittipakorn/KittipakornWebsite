...
export default function Navbar() {
    ...
    return (
        <nav className="font-roboto z-50 sticky w-[100vw] top-0 py-5 bg-gray-100 drop-shadow-xl">
            <div className="flex justify-left max-md:hidden">
                <ul className="flex">

                    <Link href='/project'><Image src="https://i.ibb.co/R35CDmY/logo-removebg-preview.png" alt="logo" className="h-5 ml-10 object-contain" width={100} height={1000} /></Link>
            ...
            <div className={`flex flex-col`}>
                <div className="flex justify-between md:hidden mx-4">
                    <Link href='/project'><Image src="https://i.ibb.co/R35CDmY/logo-removebg-preview.png" alt="logo" className="h-5 object-contain" width={100} height={1000} /></Link>
